...
public class UserControllerTest {
    ...
    public void signupWithWrongPasswordType() throws Exception {
        ...
        userProfile.setId(1);
        userProfile.setEmailAddress("SMittal@gmail.com");
        userProfile.setFullName("S Mittal");
        userProfile.setMobileNumber("9045611111");
    ...
    public void signinWithCorrectCredentials() throws Exception {
        ...
        userProfile.setId(1);
        userProfile.setEmailAddress("SMittal@gmail.com");
        userProfile.setFullName("SMittal");
        userProfile.setMobileNumber("9045611111");
        user.setProfile(userProfile);
        user.setId(1);
        user.setUsername("SM");
